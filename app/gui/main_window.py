...
class MainWindow(ctk.CTk):
    ...
    def init_main_window(self, _=None) -> None:
        def init_main_left_side(_=None) -> None:
            def init_search_left_side(_=None) -> None:
                ...
                back_arrow_image = ctk.CTkImage(light_image=Image.open("app/assets/icons/arrow_left.png"),
                                                size=(18, 13))
                back_button = self.styled_button(self.upper_left_frame, text="", height=30, width=40, corner_radius=5,
                                                 image=back_arrow_image, command=init_main_left_side)
            ...
            open_side_menu_button = self.styled_button(self.upper_left_frame, text="", image=burger_menu_image,
                                                       width=40, height=30, corner_radius=5, command=init_side_menu)
        ...
        right_side.bind("<Button-1>", self.init_main_window)
